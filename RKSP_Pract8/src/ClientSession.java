...
public class ClientSession implements Runnable{
    ...
    private int send(String reqType, String header) throws IOException {
    ...
    private int GET(String header) throws IOException {
        ...
        if((resStream = HttpServer.class.getResourceAsStream(resourcePath)) != null
                && (code == 200 || code == 404)){
        ...
        if(!params.isEmpty()){
            ...
            if(params.containsKey("romanNumber")){
                ...
                if(params.get("type").equals("add")){
                    ...
                    boolean res = DataManager.getInstance().removeCarById(id);
                    ...
                    String color = params.get("color");
                    String year = params.get("year");
                    boolean res = DataManager.getInstance().updateCarById(id, price, color, year);
